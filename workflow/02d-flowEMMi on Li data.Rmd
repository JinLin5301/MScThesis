---
title: "02d-flowEMMi on Li data"
date: "Compiled at `r format(Sys.time(), '%Y-%m-%d %H:%M:%S', tz = 'UTC')` UTC"
output: github_document
params:
  name: "02d-flowEMMi on Li data" # change if you rename file
---
...
Based on the scatter plot in 01-data, we could tell that except for the sample taken in the surrounding region, the cells of other region samples are mostly concentrated in the range of 500 to 4000.

```{r flowEMMI-Li,results='hide',eval=F}
set.seed(1)
gating_Nov <- list()
